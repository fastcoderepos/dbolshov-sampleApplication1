...
public class StaffControllerTest {
    ...
    public void CreateStaff_StaffDoesNotExist_ReturnStatusOk() throws Exception {
        ...
        staffInput.setStoreId(Integer.parseInt(store.getStoreId().toString()));
    ...
    @Test
    public void CreateStaff_storeDoesNotExists_ThrowEntityNotFoundException() throws Exception {
        CreateStaffInput staff = createStaffInput();
        ObjectWriter ow = new ObjectMapper()
            .registerModule(new JavaTimeModule())
            .disable(SerializationFeature.WRITE_DATES_AS_TIMESTAMPS)
